    ...
    <header>
        ...
        dark:from-gray-600 dark:to-gray-900 mx-auto z-30 py-5 px-6 lg:px-20 2xl:px-0'>
          ...
          <div className="flex gap-4">
              ...
              dark:hover:text-white dark:hover:bg-gray-500 elegance:bg-elegance-500 elegance:hover:text-elegance-500' onClick={toggle}><i className="bi bi-cart4"></i> Carrito</button>
          </div>
      </nav>
    </header>
  )
